    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-gray-600">
          Si recibiste productos con imperfecciones o defectos, repórtalos aquí para que podamos ayudarte.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmitReporte} className="bg-white rounded-lg shadow-md p-6 space-y-6">
        ...
        {/* Seleccionar Producto (solo si hay un pedido seleccionado) */}
        {selectedPedido && (
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
        ...
        {/* Cantidad Defectuosa (solo si hay un producto seleccionado) */}
        {selectedProducto && (
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
