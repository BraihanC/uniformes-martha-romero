...
import { Package, DollarSign, CheckCircle, Clock, Eye, Plus, Calendar, CreditCard, User, Building } from 'lucide-react';
              ...
              <div>
                ...
                <div className="space-y-2">
                  {selectedPedido.productos?.map((producto, index) => (
                    <div key={index} className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 bg-gray-50 p-3 rounded">
                      <div className="flex-1">
                        <p className="font-medium text-gray-800 text-sm md:text-base">{producto.descripcion}</p>
